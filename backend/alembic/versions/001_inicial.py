...
def upgrade() -> None:
    ...
    op.create_table('wounds',
        ...
        sa.Column('first_seen_at', sa.Date(),       nullable=False, server_default=sa.func.current_date()),
    ...
    op.create_table('wound_evaluations',
        ...
        sa.Column('timers_disclaimer',          sa.Text(), nullable=False, server_default='Sugerencia educativa basada en guías TIMERS. No reemplaza el criterio clínico del profesional.'),
    ...
    op.create_table('inference_runs',
        ...
        sa.Column('triage_disclaimer',  sa.Text(), nullable=False, server_default='Análisis asistido por IA. Requiere validación del profesional de salud. No reemplaza el diagnóstico clínico.'),
    ...
    op.create_table('generated_reports',
        ...
        sa.Column('clinical_disclaimer', sa.Text(), nullable=False, server_default='Este informe es una herramienta de apoyo clínico. No reemplaza el diagnóstico ni el tratamiento médico.'),
        sa.Column('created_at',          sa.DateTime(timezone=True), server_default=sa.func.now()),
        sa.CheckConstraint(
